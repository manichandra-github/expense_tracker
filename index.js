...
function add_category(){
    ...
    if(new_category_value){
        ...
        var available_categories = document.getElementsByName("category")[0];
        ...
        document.getElementsByClassName("add-category")[0].getElementsByClassName.display = "none";
    }
}
...
function add_expense_page(){
    if(document.getElementsByClassName("add-new-expense")[0].style.display = "block"){
        document.getElementsByClassName("add0new-expense")[0].style.display = "none";
    }
    else{
